...
CSS Flexbox — это технология для создания сложных гибких макетов за счёт правильного размещения элементов на странице. В целом, ничего нового. Изучите материал и повторите дизайн [`05`](#05-Боковая-панель-с-меню) и [`06`](#06-Трехколоночный-дизайн) с использованием `flexbox`.
